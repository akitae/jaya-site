...
class Version20180506214234 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD parcours_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur DROP typeUtilisateur');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD typeUtilisateur VARCHAR(50) NOT NULL COLLATE utf8_unicode_ci');
    }
}
